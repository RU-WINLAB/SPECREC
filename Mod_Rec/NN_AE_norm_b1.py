...
This code run a Autencoder based on Keras 
"""
# %%
...
class NN():
    ...
    def NN_autoecoder(self, hidden, act1 = "relu", act2 = "softsign", numClasses = 2):
        ...
        hidden = Dense(12, activation= act1)(hidden)
        hidden = Dense(8, activation= act1)(hidden)
        hidden = Dense(4, activation = act1)(hidden)
        hidden = Dense(2, activation = act1)(hidden)

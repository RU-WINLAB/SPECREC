...
from signal_8psk import signal_8psk  # grc-generated hier_block

class data_gen_8psk_16qam(gr.top_block):
    ...
    def __init__(self, filename='file1.bin', noise_voltage=0.150, samp_rate=20e6, sig1_bw=1.5e6, sig1_freq=7e6, sig2_bw=4e6, sig2_freq=-5e6):
        ...
        # Blocks
        ##################################################
        self.signal_8psk_0 = signal_8psk(
        ...
        self.connect((self.signal_8psk_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.signal_8psk_0.set_samp_rate(self.samp_rate)
    ...
    def set_sig1_bw(self, sig1_bw):
        self.sig1_bw = sig1_bw
        self.signal_8psk_0.set_signal_bandwidth(self.sig1_bw)
    ...
    def set_sig1_freq(self, sig1_freq):
        self.sig1_freq = sig1_freq
        self.signal_8psk_0.set_offset_freq(self.sig1_freq)
...
def main(top_block_cls=data_gen_8psk_16qam, options=None):
    if options is None:

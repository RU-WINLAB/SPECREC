...
class data_gen_bpsk_8psk(gr.top_block):
    ...
    def __init__(self, filename='file1.bin', noise_voltage=0.150, samp_rate=20e6, sig1_bw=1.5e6, sig1_freq=7e6, sig2_bw=4e6, sig2_freq=-5e6):
        ...
        self.connect((self.signal_8psk_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_sig2_bw(self, sig2_bw):
        self.sig2_bw = sig2_bw
        self.signal_8psk_0.set_signal_bandwidth(self.sig2_bw)
    ...
    def set_sig2_freq(self, sig2_freq):
        self.sig2_freq = sig2_freq
        self.signal_8psk_0.set_offset_freq(self.sig2_freq)
...
def main(top_block_cls=data_gen_bpsk_8psk, options=None):
    if options is None:

...
class data_visualize(gr.top_block, Qt.QWidget):

    def __init__(self, samp_rate=100e6):
        gr.top_block.__init__(self, "Synthetic Data Visualization")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Synthetic Data Visualization")
        ...
        self.settings = Qt.QSettings("GNU Radio", "data_visualize")
        ...
        # Blocks
        ##################################################
        self.signal_QPSK_0_0 = signal_QPSK(
            offset_freq=-5e6,
            samp_rate=samp_rate,
        ...
        self.connect((self.signal_QPSK_0_0, 0), (self.blocks_add_xx_0_0, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.signal_QPSK_0_0.set_samp_rate(self.samp_rate)
...
def main(top_block_cls=data_visualize, options=None):
    if options is None:

...
class data_gen_16qam_full_bw(gr.top_block):

    def __init__(self, samp_rate=2.0e6):
        gr.top_block.__init__(self, "16QAM full bandwidth")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '16qam_full_bw.bin', False)
        ...
        self.connect((self.signal_16qam_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_sig1_bw(self, sig1_bw):
        ...
        self.signal_16qam_0.set_signal_bandwidth(self.sig1_bw)
...
def main(top_block_cls=data_gen_16qam_full_bw, options=None):
    if options is None:

...
class data_gen_gmsk_16qam_fullband(gr.top_block):

    def __init__(self, filename='data_gmsk_16qam.bin', samp_rate=20.0e6, sig1_freq=5e6):
...
def argument_parser():
    ...
    parser.add_argument(
        "--filename", dest="filename", type=str, default='data_gmsk_16qam.bin',
...
def main(top_block_cls=data_gen_gmsk_16qam_fullband, options=None):
    if options is None:

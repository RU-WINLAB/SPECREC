...
class data_gen_bpsk_cpm_fullband(gr.top_block):

    def __init__(self, filename='data_bpsk_cpm.bin', samp_rate=20.0e6, sig1_freq=5e6):
        ...
        self.connect((self.signal_cpm_0, 0), (self.blocks_throttle_0, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "--filename", dest="filename", type=str, default='data_bpsk_cpm.bin',
...
def main(top_block_cls=data_gen_bpsk_cpm_fullband, options=None):
    if options is None:

...
from signal_cpm import signal_cpm  # grc-generated hier_block

class data_gen_cpm_16qam_fullband(gr.top_block):

    def __init__(self, filename='data_cpm_16qam.bin', samp_rate=20.0e6, sig1_freq=5e6):
        ...
        self.connect((self.signal_cpm_0, 0), (self.blocks_throttle_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.signal_16qam_0.set_signal_bandwidth(self.samp_rate)
        self.signal_cpm_0.set_samp_rate(self.samp_rate)
        self.signal_cpm_0.set_signal_bandwidth(self.samp_rate)
    ...
    def set_sig1_freq(self, sig1_freq):
        self.sig1_freq = sig1_freq
        self.signal_16qam_0.set_offset_freq(self.sig1_freq)
        self.signal_cpm_0.set_offset_freq(self.sig1_freq)


def argument_parser():
    parser = ArgumentParser()
    parser.add_argument(
        "--filename", dest="filename", type=str, default='data_cpm_16qam.bin',
...
def main(top_block_cls=data_gen_cpm_16qam_fullband, options=None):
    if options is None:
